...
public static String now() {
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws
        ...
        try{
       		/*Draw Header*/
    //int y=80;
        	System.out.println("Before Header:::::"+g2d.getFont());
      ...
      g2d.setFont(font1);
      System.out.println("Before Body:::::"+g2d.getFont());
      ...
      g2d.setFont(font);
        ...
        System.out.println("Before Grand Total:::::"+g2d.getFont());
        ...
        System.out.println("Before ThankYou:::::"+g2d.getFont());
