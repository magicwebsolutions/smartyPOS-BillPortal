...
<body>
<form action="/BillPortal_V2/Billhandler" method="post" ID="BILLFORM">
	<div id="title">
	...
	<font size="5"><b>Smarty POS</font>
	<font size="5"><b style="margin-left: 63%;">ABC Stores, Ramapuram, Chennai</b></font>
	</div>
	
	<div id="header_Bill">
	<%-- <font size="5"><b>Bill No::<%=bill_Number%></b></font>	
	<input type="button" id="Maintain" name="Maintain" value="Maintenence" onclick="openmaint();" style="margin-left:92%; margin-top:-1.50%;color: blue"></input>
	...
	<img src = "Images/setting-noresulticon.png">
	...
	<label style ="margin-right: 10%"><b>MRP</b></label>
	<label style ="margin-right: 6%"><b>TOTAL</b></label>
	...
	<td width="5%">
	<input type="text" id="currTotal" name="currTotal" readonly onkeydown="return 	;"></input>
	</td>
	<td>	
	...
	<div id="bottomright">
	<b style="margin-left:4%; margin-top:9.50%"> <font size="5">TOTAL</font></b>
	...
	<label><b style="margin-left:4%; margin-top:9.50%"><font size="5">PAID</font></b></label>
	...
	<b style="margin-left:4%"><font size="5">BALANCE</font></b>
	...
	function resetForm()
	{
		...
		// change it's content
		label.innerHTML = "<span style ='font-size:200%'><Strong>" + 'Total Items:'+totalCount +"</Strong></span>";		
