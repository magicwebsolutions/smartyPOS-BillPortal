...
<html>
	...
	<div id="header"> 
		...
		<div id="nav">
			<font color=white>
				<ul>
					...
					<li><a href="#" onclick="ViewSalesDetails();"> <font color=white><b>SALES DETAILS</b></font></a></li>			
				</ul>
			</font>
		</div>
		...
		<div id="section1">
			<form action="/BillPortal_V2/MasterServlet" method=post ID="ADDITEMFORM">
		...
		<div id="section2">
			<form action="/BillPortal_V2/MasterServlet" method=post  ID="MODIFYITEMFORM">
		...
		<div id="section3">	
			<form action="/BillPortal_V2/MasterServlet" method=post  ID="VIEWITEMFORM">
	...
	<div id="section4">
		<form action="/BillPortal_V2/MasterServlet" method=post  ID="DELETEITEMFORM">
		...
		<div id="section5">
			...
			<form action="/BillPortal_V2/MasterServlet" method=post ID="GETPASSCHANGEFORM">
		...
		<div id="section6">
			...
			<form action="/BillPortal_V2/MasterServlet" method=post ID="GETSALESDETAILSFORM">
			<input type="hidden" name="EVENT" maxlength=25 value="GETPASSCHANGE"></input>
			<h1 style="margin-left: 1%;">Sales Details</h1>
			<span class="labelClass" style="margin-left: 2%; margin-top: 0.4%">FROM DATE</span>
			<input type="Date" id="FromDate" name="FromDate" style= "margin-left: -41%; "></input>
			<span class="labelClass" style="margin-left: 8%;  margin-top: 0.4%">TO DATE</span>
			<input type="Date" id="ToDate" name="ToDate" style= "margin-left: 15%;"></input><p>
			<span class="labelClass" style="margin-left: 2%;  margin-top: 0.4%">TOTAL SALE</span>
			<input type="text" id="I_Unit_4" name="I_Unit_4" maxlength=25 style="margin-left: -11.5%;"></input><p>
