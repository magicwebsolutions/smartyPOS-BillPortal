...
function HelloAlert(){
	...
	//alertify.alert("aslkjflskdjfklsdjflkj");
...
//window.location.replace("/BillPortal_V2/Billhandler?Event=NEWBILL");
}
...
<img alt="no img" src="Images/bg1.jpg" style="width: 100%;height: 101%;position: absolute">
...
<label style="
    ...
    <a href="#" id="link" style="color: black;margin-left: 11%;"><b> Forgot Password </b></a>
    </p>
    
<p style="position: relative; margin-left: 38%;">
    
<input type="button" onclick="HelloAlert()"  value="Submit" id="submit11" style="
	    margin-left: 11%;
    width: 37%;
    font-size: 110%;
    color: indianred;">
...
<img alt="no img" src="Images/bg.jpg" style="width: 100%;height: 101%;position: absolute">
...
<div id="image" style="margin-top: 2%; display: none;">
  ...
  <input type="image" src="Images/bill.jpg" alt="no image" value="submit" id="billSubmit11" style="
    width: 57%;
    font-size: 110%;
    color: indianred;
    min-height: 359%;
  ...
  <input type="image" src="Images/maintainence.jpg" alt="no image" value="submit" id="maintain11" style="
    width: 89%;
    font-size: 110%;
    color: indianred;
    margin-top: :-19%;
...
<div id="credentials1" style="position: fixed;display:none">
<label>Forgot Password..? No Worries..!</label>
<label style="
    position: fixed;
    margin-top: 11%;
    margin-left: -34%;
...
<label style="
    ...
    font-size: 125%;
    color: black;
    ">Re-enter New Password</label><input type="password" id="User_pwd2" name="User_pwd2" style="
    margin-top: 17%;
    position: fixed;
    margin-left: -18%;
    width: 10%;
